  ...
  return (
    <SidebarInset>
      <header className="flex h-16 shrink-0 items-center gap-2 border-b border-pathway-gold/20 px-4 bg-pathway-green/5">
        ...
        <h1 className="text-lg font-semibold text-pathway-green">Deliveries</h1>
      ...
      <div className="flex-1 space-y-6 p-6">
        <div className="grid gap-4">
          {deliveries.map((delivery) => (
            <Card key={delivery.id} className="hover:shadow-md transition-shadow border-pathway-gold/20">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    <CardTitle className="flex items-center gap-2 text-pathway-green">
                      <Truck className="h-5 w-5 text-pathway-gold" />
                      {delivery.material}
                    </CardTitle>
                    <CardDescription className="flex items-center gap-4">
                      <span className="flex items-center gap-1 text-pathway-green/70">
                        <Calendar className="h-3 w-3 text-pathway-gold" />
                        {new Date(delivery.date).toLocaleDateString()}
                      </span>
                      <span className="text-pathway-green/70">{delivery.project}</span>
                    </CardDescription>
                  </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <DialogContent className="max-w-2xl border-pathway-gold/30">
          <DialogHeader>
            <DialogTitle className="text-pathway-green">Add New Delivery</DialogTitle>
